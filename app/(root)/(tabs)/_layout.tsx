...
const TabIcon=({focused,source}:{
  ...
  <View className={`flex flex-row items-center justify-center rounded-full ${focused?"bg-general-300":""}`}>
    <View className={`rounded-full h-12 w-12 items-center justify-center ${focused?"bg-general-400":""}`}>
      <Image source={source} alt="" resizeMode="contain" tintColor="white" className="w-7 h-7"/>
    </View>
  </View>
)
